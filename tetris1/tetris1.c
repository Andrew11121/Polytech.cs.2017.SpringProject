...
void SetupSystem() // общие организационные действи€.Ќапример: задание зерна генератору случайных чисел.
{
	srand(time(0));
	consoleHandle = GetStdHandle (STD_OUTPUT_HANDLE);
}

void Initialise() // »нициализаци€ вводимых данных, представленных в виде программного кода,
{
...
void Update() // основна€ логика игры.
{
